...
export default function WhatsAppSimulator({
  ...
  return (
    <div className="w-[375px] h-[812px] mx-auto overflow-hidden bg-[#0b141a] flex flex-col shrink-0">
      ...
      <div
        ref={scrollRef}
        className="flex-1 overflow-y-auto px-[10px] py-2 relative"
        style={{
          display: 'flex',
      ...
      >
        {messages.map((msg, idx) => {
          ...
          const marginTop = idx === 0 ? 0 : sameSenderAsPrev ? 2 : 6;
          ...
          return (
            ...
            >
              <div
                style={{ maxWidth: '75%' }}
                className={`${msg.image ? "p-[3px]" : "px-[9px] pt-[6px] pb-[8px]"} text-[14.2px] leading-[19px] relative break-words ${
                  isMe
        ...
        {isTyping && typingSender === "them" && (
          <div style={{ display: 'flex', alignSelf: 'flex-start' }} className="animate-message-in">
      ...
      <div className="flex items-center gap-[6px] px-[6px] py-[6px]" style={{ backgroundColor: "#0b141a" }}>
        <div className="flex-1 flex items-center gap-[6px] bg-[#1f2c34] rounded-full px-[12px] py-[10px] min-h-[42px] min-w-0">
          ...
          <div style={{ flex: 1, minWidth: 0, overflow: 'hidden', whiteSpace: 'nowrap', direction: 'ltr', textAlign: 'left' }} className="text-[15px] text-[#e9edef]">
